...
- **Fréquentiel**: est-ce que les données sont conforment avec avec l'hypothèse de la vie sur Mars 
...
ggplot(data = exemple_ech, mapping = aes(x = value)) +
  geom_histogram(mapping = aes(fill = echantillon), color = "gey35", bins = 10)
...
ggplot(res_df, aes(x = nitro, y = residus_lm)) +
  ...
  geom_hline(yintercept = 0, col = "gey35", size = 2)
```
