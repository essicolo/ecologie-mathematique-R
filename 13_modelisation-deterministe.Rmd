...
# isoclines
abline(v=lapin_iso, lty=2)
abline(h=renard_iso, lty=2)
...
Dans ce cas, le nombre de lapins atteint systématiquement un état critique, mais se recouvre sans cesse. Il serait toutefois étonnant que les paramètre soient constants. On peut admettre que les paramètres varient en fonction de paramètres mesurés, ou simplement au hasard. Il est possible d'ajouter de la stochastique (processus aléatoire) dans nos fonctions. En outre, plusieurs simulations pourront nous indiquer un risque d'effondrement d'un écosystème.
