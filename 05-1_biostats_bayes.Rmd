...
```
reticulate::conda_create(envname = "r-greta", packages = c("python", "tensorflow=1.14"))
reticulate::conda_install(envname = "r-greta", packages = "tensorflow-probability==0.8", pip=TRUE)
```
...
```{r, eval = FALSE}
library("greta")
reticulate::use_condaenv("r-greta") # sélectionner l'environnement coda (Python) auquel se conencter
library("DiagrammeR")
library ("bayesplot")
library("tidybayes")
