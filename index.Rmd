...
En établissant des règles correspondant aux mécanismes de l'objet étudié, il devient possible de modéliser l'évolution des systèmes vivants, comme l'émergence d'espèces invasives. La figure \@ref(fig:index-cellular-automata) présente un cas simple d'automates cellularies généré dans le langage de programmation R.

```{r index-cellular-automata, out.width="50%", fig.align="center", fig.cap="Simulation avec automates cellulaires [généré en R](https://www.r-bloggers.com/fast-conways-game-of-life-in-r/).", echo = FALSE}
...
```{r index-ecologie-mathematique, out.width="40%", fig.align="center", fig.cap="Domaines scientifiques de l'écologie mathématique. Source: Anonyme, publié sur [Giphy](https://giphy.com/gifs/misc-dkaEYYiCDclAA).", echo = FALSE}
