...
Simulation avec automates cellulaires. Source: Anynyme, publié sur [Giphy](https://giphy.com/gifs/misc-dkaEYYiCDclAA).
...
Ce manuel est créé dans un environnement intéractif de type *carnet de notes* ([Jupyter lab](https://jupyter.org)). Ce format permet d'intercaller des cellules de texte et des cellules de calcul.
...
- Utiliser Jupyter lab en local sur Anaconda ou dans les nuages sur MyBinder ou Azure notebooks
