...
Ce manuel est créé dans un environnement interactif de type *carnet de notes* ([Jupyter lab](https://jupyter.org)). Ce format permet d’intercaler des cellules de texte et des cellules de calcul.
...
Les chapitres de ce manuel sont composés dans un environnement de travail de type *notebook*, grâce à **Jupyter lab**. Pour exécuter les commandes, les utilisateurs.trices pourront:
