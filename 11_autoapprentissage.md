...
```
    ...
    ## Sensitivity            0.4958   0.5510   0.4836
    ## Specificity            0.7422   0.9442   0.6696
    ## Pos Pred Value         0.3650   0.9194   0.3089
    ## Neg Pred Value         0.8312   0.6455   0.8094
    ## Prevalence             0.2301   0.5360   0.2339
    ## Detection Rate         0.1141   0.2953   0.1131
    ## Detection Prevalence   0.3126   0.3212   0.3663
    ## Balanced Accuracy      0.6190   0.7476   0.5766
